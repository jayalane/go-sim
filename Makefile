...
test-long:
	go test ./... -v -v -tags=long -coverprofile fmtcoverage.html
	gotestsum  --junitfile junit.xml -- -tags=long ./...
	cat junit.xml

.PHONY: tidy proto all_mod test test-long
